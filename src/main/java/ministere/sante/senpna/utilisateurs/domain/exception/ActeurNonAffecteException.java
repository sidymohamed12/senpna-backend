 ...
 */
public class ActeurNonAffecteException extends BusinessRuleException {
    public ActeurNonAffecteException() {
        super("Vous devez être rattaché à un entrepôt pour créer ce compte", "ACTEUR_NON_AFFECTE");
    }
}
