...
@Service
public class DeactivateFournisseurUseCaseImpl implements DeactivateFournisseurUseCase {
    ...
    public DeactivateFournisseurUseCaseImpl(FournisseurRepositoryPort fournisseurRepositoryPort,
    ...
    @Override
    @Transactional
    public FournisseurDetail desactiver(DeactivateFournisseurCommand command) {
