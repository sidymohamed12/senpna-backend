 ...
 * (ex: la PNA centrale).
 */
public class TypeEntrepotInvalideException extends BusinessRuleException {
    public TypeEntrepotInvalideException() {
        super("Cette opération n'est autorisée que pour un entrepôt de type PRA", "INVALID_ENTREPOT_TYPE");
    }
}
