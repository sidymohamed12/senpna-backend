 ...
 */
public class MediaTypeNonAutorisePubliquementException extends ForbiddenException {

    public MediaTypeNonAutorisePubliquementException(String mediaType) {
        super("Le type de média '" + mediaType
                + "' ne peut pas être demandé sans authentification", "MEDIA_TYPE_NON_AUTORISE_PUBLIQUEMENT");
    }
}
