...
@Service
public class GetActualiteUseCaseImpl implements GetActualiteUseCase {

    private final ActualiteRepositoryPort actualiteRepositoryPort;
    private final ActualiteDetailAssembler assembler;

    public GetActualiteUseCaseImpl(ActualiteRepositoryPort actualiteRepositoryPort,
    ...
    public ActualiteDetail obtenir(GetActualiteQuery query) {
